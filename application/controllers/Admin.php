...
class Admin extends CI_Controller
{
    ...
    /****** DAILY ATTENDANCE *****************/
    function manage_attendance($date='',$month='',$year='',$teacher_id='')
    {
        ...
        if($_POST)
        {
            ...
            foreach ($students as $row)
            {
                $attendance_status  =   $this->input->post('status_' . $row['teacher_id']);
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(base_url() . 'index.php?admin/manage_attendance/'.$date.'/'.$month.'/'.$year.'/'.$teacher_id,'refresh');
        }
        $page_data['date']     =    $date;
