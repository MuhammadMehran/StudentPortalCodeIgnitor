					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="major" class="form-control">
                              <option value=""><?php echo get_phrase('select');?></option>
                              <option value="pre medical" <?php if($row['major'] == 'pre medical')echo 'selected';?>><?php echo get_phrase('pre medical');?></option>
                              <option value="pre Engineering"<?php if($row['major'] == 'pre Engineering')echo 'selected';?>><?php echo get_phrase('pre Engineering');?></option>
                              <option value="ICS"<?php if($row['major'] == 'ICS')echo 'selected';?>><?php echo get_phrase('ICS');?></option>
                          </select>
						</div> 
					</div>
